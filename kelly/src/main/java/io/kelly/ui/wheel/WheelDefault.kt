...
object WheelDefaults {
    ...
    const val DEFAULT_VISIBLE_COUNT = 5
    ...
    val animator: GraphicsLayerScope.(Float) -> Unit = { ratio ->
        rotationX = lerp(0f, 60f, ratio)
        scaleX = lerp(1f, 0.8f, ratio)
        scaleY = lerp(1f, 0.8f, ratio)
        alpha = lerp(1f, 0.4f, ratio)
    }
}
